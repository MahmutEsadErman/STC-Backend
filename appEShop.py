...
@app.route('/homepage',methods=["POST"]) # login basarili olduktan sonra ya da olmadan once rastegele categorilerin altinda product olusur
def homepage():
    conn = None
    cursor = None
    try:
...
@app.route('/categories/<category_id>',methods=["POST"]) # categori belirlendikten sonra o categori icerisindeki productlar gonderilir
